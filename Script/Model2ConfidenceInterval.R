...
mod2.prof.q <- read.csv("Results/Data/Model2-ProfileLikelihoodOfCatchability-Oct192019-08-06-31.csv")
...
mod2.prof.M <- read.csv("Results/Data/Model2-ProfileLikelihoodOfNaturalMortality-Oct192019-08-09-27.csv")
...
mod2.prof.s1 <- read.csv("Results/Data/Model2-ProfileLikelihoodOfS1-Oct192019-08-12-54.csv")
...
mod2.prof.s2 <- read.csv("Results/Data/Model2-ProfileLikelihoodOfS2-Oct192019-08-16-02.csv")
