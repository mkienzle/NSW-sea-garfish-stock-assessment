...
p <- ggplot(catch, aes(x=Year, y=Catch.in.kg * 1e-3)) +
            geom_bar(stat="identity") + xlab("") + ylab("Catch (t)") + 
...
<!-- <!-- CREATED using https://www.r-bloggers.com/2020/09/deploying-flexdashboard-on-github-pages/ --> -->
<!-- --- -->
<!-- title: "NSW seagarfish data used for stock assessment" -->
<!-- output:  -->
<!--   flexdashboard::flex_dashboard: -->
<!--     orientation: columns -->
...
<!--                         ylab = "Catch (tonnes)", ylim = c(0, 120), axes = TRUE, xlab = "")) -->
